...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Extracts circular reads based on circle_file from the sample.bam and writes them into circle separated bamfiles.')
    ...
    parser.add_argument('junctionfile', metavar='Chimeric.out.junction',
                        help='STAR Chimeric.out.junction file containing the readnames and coordinates of chimerically spliced reads.')
    # option
    parser.add_argument('-m', dest='mate2', default='none',
                        help='If data is paired end and mates were mapped separately, STAR Chimeric.out.junction file containing the readnames and coordinates of chimerically spliced reads of mate2.')
