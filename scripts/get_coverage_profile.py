...
def write_coverage_profile(inputfolder, coverage_profile, sample, circle_id, transcript):
	...
	if t == transcript:
	    out = open('%s/%s.coverage_profiles/%s_%s_%s.%s.txt' %(inputfolder, sample, circle_id[0], circle_id[1], circle_id[2], transcript), 'w')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='script to get the coverage profile of all circRNA files in the inputfolder.')
