...
#lola = '5_27382755_27469485_27reads.sorted.bam'


#lola = '5_27382755_27469485_172reads.sorted.bam'
#bamfolder = '.'
#outfile = '../test'
#bedfile = '/beegfs/group_dv/home/FMetge/genomes/mus_musculus/GRCm38_79/mm10.ensembl.exons.bed'
...
#num_reads = int(lola.split('_')[-1].split('.')[0]. replace('reads', ''))
##MATES, FRAGMENTS = get_reads_from_bamfile('%s/%s' %(inputfolder, lola), circle_coordinates)
#bamfile = '%s/%s' %(bamfolder, lola)

#circle = pysam.AlignmentFile(bamfile, "rb")
#for i in circle:
    #print(i.reference_start)
    #print(i.reference_end)
